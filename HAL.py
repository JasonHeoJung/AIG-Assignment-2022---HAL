...
def run():
    ...
    red_knight = Knight_FF(world, red_knight_image, red_base, Vector2(red_base.spawn_position))
    ...
    red_archer = Archer_FF(world, red_archer_image, red_arrow_image, red_base, Vector2(red_base.spawn_position))
    ...
    red_wizard = Wizard_FF(world, red_wizard_image, red_rock_image, red_base, Vector2(red_base.spawn_position), red_explosion_image)
